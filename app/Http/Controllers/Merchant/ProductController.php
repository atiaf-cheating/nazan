...
//        }
        ...
        if(!$allProducts){
            return view('merchant.products.index',['products'=>[]]);
        }

        return view('merchant.products.index',[ 'products'=>$allProducts]);
    }
    /**
...
//            dd($arr);
        ...
        if(!$product){
            ...
            return redirect('merchant/control/products/');
        }
    ...
    public function edit($id)
    {
        ...
        $merchant_id = Merchant::find(Session::get('merchant_id'));
//        dd($merchant_id);
//            ->where('deleted_at',null)
//            ->orderBy('order', 'asc')
//            ->orderBy('arabic_name', 'asc')
