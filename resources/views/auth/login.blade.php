...
<div class="login-box" style="width: 100%;height:100%">
    <div class="login-logo">
        <a href=""><b>Nazan</b>Project</a>
    </div>
    <!-- /.login-logo -->
    <div class="card" style="height: 100%;">
        <div class="card-body">
            <p class="login-box-msg">{{ isset($url) ? ucwords($url) : ""}}  Sign in to start your session</p>

            @isset($url)
                            <a href="{{ route('/register/'.$url) }}">@lang('messages.register')</a><br><br>
