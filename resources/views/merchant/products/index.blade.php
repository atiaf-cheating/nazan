...
{{--@php                dd($product->category)@endphp--}}
                ...
                <tr class=" @if($language == 'ar') rtl @endif">
                    ...
                    <th class=" @if($language == 'ar') rtl @endif">
                        ...
                        <a href="{{url('/merchant/control/products/edit/'.$product->id)}}" class="btn btn-info @if($language == 'ar') rtl @endif">@lang('messages.edit')</a>
                        <a href="{{url('/merchant/control/products/activate/'.$product->id)}}" class="btn btn-warning @if($language == 'ar') rtl @endif">@if($product->active == 0) @lang('messages.activate') @else @lang('messages.deactivate') @endif</a>
                        <a href="{{url('/merchant/control/products/delete/'.$product->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger @if($language == 'ar') rtl @endif">@lang('messages.delete')</a>
                    </th>
                </tr>
            @endforeach
            </tbody>
