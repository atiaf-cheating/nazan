...
@section('content')
    ...
    <div class="row @if($language == 'ar') rtl @endif " style=" margin-top: 2%; margin-left: 2%;;padding:0;">
        <div class="col  @if($language == 'ar') rtl @endif">
            <h2><i class="fa fa-plus @if($language == 'ar') rtl @endif" style="background: #74777a;border-radius: 500%;font-size: 1.1rem;padding: 6px;color: #EEE;position: relative;top: -2px;"></i> &nbsp;@lang('messages.edit coupon')</h2>
        </div>
    </div>
    @if ($errors->any())
    ...
    @endif
    <form method="post" action="{{url('coupons/update/'.$coupon->id)}}"  enctype="multipart/form-data" class=" @if($language == 'ar') rtl @endif" style="width: 90%;border-top: 4px solid #007BFF;padding: 3%; margin: 2%;background: white;">
        {{ csrf_field() }}
        <div class="form-group  row @if($language == 'ar') rtl @endif" id="select_cat">
            ...
            <div class="col-md-4">
                <input type="text" value="{{$coupon->code}}" name="code"  class="form-control @if($language == 'ar') rtl @endif" id="code" placeholder="enter code">
            </div>&nbsp;
            <div class="col-md-4">
                or <button type="button" class="btn btn-primary @if($language == 'ar') rtl @endif" style="float:right;">@lang('messages.generate code automatic')</button>
            </div>&nbsp;
        </div>
        <div class="form-group  @if($language == 'ar') rtl @endif">
            ...
            <input type="text" value="{{$coupon->discount_percentage}}" name="discount_percentage"  class="form-control @if($language == 'ar') rtl @endif" id="discount_percentage" placeholder="enter discount percentage">
        </div>
        {{--            <div class="form-group  @if($language == 'ar') rtl @endif">--}}
        ...
        <div class="form-group  @if($language == 'ar') rtl @endif">
            ...
            <input type="date" value="{{$coupon->expiry_date}}" name="expiry_date"  class="form-control @if($language == 'ar') rtl @endif" id="expiry_date" placeholder="enter phone">
        </div>
